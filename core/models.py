...
class db_MANUFACTURER(models.Model):
    ...
    access_id=models.CharField(max_length=500,null=True)
    username=models.CharField(max_length=500,null=True)
    access_key=models.CharField(max_length=1000,null=True)
    content_type=models.CharField(max_length=1000,null=True)
    grant_type=models.CharField(max_length=1000,null=True)
    email= models.CharField(max_length=255,null=True)
    address= models.TextField(max_length=1000,null=True)
    person_name= models.CharField(max_length=255,null=True)
...
class db_aq_aggregated(models.Model):
    id = models.AutoField(primary_key=True)
    pm10= models.FloatField(null=True)
    co = models.FloatField(null=True)
    so2= models.FloatField(null=True)
